...
function run() {
  ...
  console.log(score);
  if (score == 0) {
    out.innerHTML = " 0/4, did you even try?";
  } else if (score == 1) {
    out.innerHTML = " 1/4, better luck next time!";
  } else if (score == 2) {
    out.innerHTML = " 2/4, Thats decent!";
  } else if (score == 3) {
    out.innerHTML = " 3/4, good job !";
  } else if (score == 4) {
    out.innerHTML = " 4/4, EXCELLENT!!!!!!!!!";
  }
}
